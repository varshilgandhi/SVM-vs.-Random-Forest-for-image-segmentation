# -*- coding: utf-8 -*-
"""
Created on Sat May 15 07:11:10 2021
...
img = cv2.imread('train_masks\\Sandstone_Versa0000.tif')
...
#w stands for write mode and b stands for binary

#load or open our model
load_model = pickle.load(open(filename, 'rb'))
#rb stands for read and binary

#predict our loaded model corresponding to X OR Y 
result = load_model.predict(X)

#Reshape this result into our original image size so we can understand it perfectly
segmented = result.reshape((img.shape))

#Let's visualize it
from matplotlib import pyplot as plt
plt.imshow(segmented, cmap='jet')
plt.imsave('segmented_rock.jpg', segmented, cmap='jet')  #cmap = colormap
